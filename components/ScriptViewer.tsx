...
export const ScriptViewer: React.FC<ScriptViewerProps> = ({ initialSections = [], title, onBack, protagonistName, scriptType, onResetKey }) => {
  ...
  const [protagonist, setProtagonist] = useState<Protagonist>({
    description: `A cute Chibi-style financial expert named ${protagonistName}, large expressive eyes, 2.5 heads tall ratio, wearing a clean hoodie and sneakers, thick black outlines, flat cartoon style, full body view`,
    imageUrl: undefined,
  });
